...
class CellCorrection(object):
    ...
    def _GMM_correction(self, gem, mask):
...
def args_parse():
    ...
    arg.add_argument('-m', '--mask_path', help='cell mask', default=r"SS200000213BR_C5_nuclei_mask.tif")
    arg.add_argument('-g', '--gem_path', help='gem file', default=r"SS200000213BR_C5.gem.gz")
